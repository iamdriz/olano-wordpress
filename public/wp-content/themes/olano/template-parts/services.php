<div class="services">
    <div class="services-list-item">
        ...
        <a class="arrow-link" href="<?php echo bloginfo('home'); ?>/services/bespoke-elearning">Explore more</a>
    </div>
    <div class="services-list-item">
        <div class="services-list-item__icon">
        ...
        <a class="arrow-link" href="<?php echo bloginfo('home'); ?>/services/classroom-virtual">Explore more</a>
    </div>
    <div class="services-list-item">
        <div class="services-list-item__icon">
        ...
        <a class="arrow-link" href="<?php echo bloginfo('home'); ?>/services/explainer-videos">Explore more</a>
    </div>
    <div class="services-list-item">
        <div class="services-list-item__icon">
        ...
        <a class="arrow-link" href="<?php echo bloginfo('home'); ?>/services/content-development">Explore more</a>
    </div>
</div>