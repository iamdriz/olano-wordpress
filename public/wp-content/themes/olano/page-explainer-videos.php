    ...
    <div class="container">
        ...
        <div class="row align-items-center">
            ...
            <div class="col md:col--7">
                <h1 class="font-size-display3">Explainer videos</h1>
...
<section id="services" class="section section--off-white">
    <div class="container">
        ...
        <div class="video-wrapper video-wrapper--blue">
            <div class="container">
                <div class="video">
                    ...
                    <div class="col md:col--3">
                        <div class="wp-block-buttons">
                            <div class="wp-block-button is-style-fill">
                                <a class="wp-block-button__link has-yellow-background-color has-background" href="/services/explainer-videos/explainer-videos-case-study">Case study</a>
                            </div>
                        </div>
                    </div>
