...
<section class="section section--red">
    <div class="container">
        ...
        <div class="row">
            <div class="col md:col--3">
                <h2 class="font-size-h3 border-top">The Olano team</h2>
            </div>
    ...
    <div class="container">
        ...
        <div class="row align-items-center">
            ...
            <div class="col md:col--7">
                ...
                <p class="font-size-lg"><strong>Curiosity:</strong> Our inquisitive nature means we take time to explore everything we do. We dig deep to get to the core of your organisations needs.</p>
                <p class="font-size-lg"><strong>Creativity:</strong> We believe everyone is creative. We want to push the boundaries of Learning and challenge the norm. </p>
                <p class="font-size-lg"><strong>Mutuality:</strong> From concept to delivery, we believe in a journey of cocreation. It doesn’t work without you, so we want to create lasting relationships through on-going two way communication.</p>
                <p class="font-size-lg"><strong>Integrity:</strong> We approach every project with authenticity and honesty. We don’t play the hero, we’re real people sharing our specialisms in an honest way.</p>
            </div>
        </div>
