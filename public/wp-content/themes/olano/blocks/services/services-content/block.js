...
(function (blocks, element, blockEditor, editor, components) {
    ...
    blocks.registerBlockType('olano/olano-services-content-block', {
        title: 'Services Content Block',
                    ...
                    */
                    el(
                        'div', { className: 'row align-items-center margin-bottom-8' },
                            el('div', { className: props.attributes.mediaAlignment == 'left' ? 'col md:col--4 md:offset-1' : 'col md:col--4 md:offset-1 md:order-2' },
                                el('figure', { className: '' },
                                    el( MediaUpload, {
