(function (blocks, element, blockEditor, editor, components) {
    ...
    blocks.registerBlockType('olano/olano-about-header-block', {
        ...
        edit: function (props) {
            ...
            return el(
                'div', { className: 'row margin-bottom-8' },
                    el('div', { className: 'col col--6 md:col--2 md:breakout-right margin-bottom-4 md:margin-bottom-0' },
                        el('figure', { className: 'figure' },
                            el( MediaUpload, {
